...
dirlist = os.listdir("/Users/aolejniczak/Desktop/SLRLaserScanner/TestImages/TestShallotTIFF/")
for files in dirlist:
	if files.endswith ('.tiff'):
		print "Now processing: " + files
	newFiles = os.path.splitext(files)[0]
	print newFiles
	fileToOpen = "/Users/aolejniczak/Desktop/SLRLaserScanner/TestImages/TestShallotTIFF/" + files
	print fileToOpen
...
#					print str(k) + "," + str(i) + " | " + str(px[k,i])
	...
	fileName = "TestImages/Results/" + newFiles + ".png"
